...
export const serviceCategories: ServiceCategoryI[] = [
    {
        ...
        services: [
            {
                title: "Contracts and Legal Documentation",
                highlights: [
                    "Development from scratch, analysis, customization",
                    "We explain what you're signing",
                    "Tailored for IT realities: SaaS, API, rental models",
                ],
                slug: "/",
            },
            {
                ...
                highlights: [
                    "Preparation for investments, M&A",
                    "Legal audit and risk clearance",
                    "Reorganization, options, cap table",
                ],
                slug: "/",
            },
            {
                title: "Litigation and Claims",
                highlights: [
                    "Representation in arbitration",
                    "Pre-trial settlement",
                    "Protection of interests in contracts and IP",
                ],
                slug: "/",
            },
            {
                ...
                highlights: [
                    "Protection of code, visuals, music, brand",
                    "Object registration",
            ...
            {
                title: "IT Benefits and Accreditation",
                highlights: [
                    "Help obtain and maintain MinDigital accreditation",
                    "Documents and support for tax benefits",
                    "Justification of digital status",
                ],
                slug: "/",
            },
        ],
