...
function TeamPerson({ props }: TeamPersonPropsI) {
  ...
  return (
    <div className={styles.person}>
      <div className={styles.imageAndAbout}>
        <div className={styles.image}>
          <img src={image} alt="" />
        </div>
        <div className={cn(styles.about, isOpenInfo && styles.active)}>
      ...
      <div className={styles.bottom}>
        <Typography variant="body-l" as={"p"} className={styles.nameFemale}>
          {dataPerson}
        </Typography>
        <Typography variant="body-m" as={"p"}>
          <b>{post}</b>
        </Typography>
        <button className={styles.button} onClick={onToggleInfo}>
          {" "}
          Подробнее{" "}
        </button>
      </div>
